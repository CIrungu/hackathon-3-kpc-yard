...
export function useYardStream(handlers = {}) {
  ...
  useEffect(() => {
    ...
    for (const evt of ["gate:entry", "bay:assigned", "loading:started", "loading:completed", "checkpoint:crossed", "anomaly:detected", "reroute:applied", "queue:sequenced", "control:override", "sla:breach"]) {
