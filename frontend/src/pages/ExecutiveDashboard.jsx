      ...
      <div className="glass glass-outline flex items-start gap-3 p-5">
        ...
        <div className="text-xs text-slate-400">
          ...
          <p className="mt-1">
            ...
            pump rate and queue forecast. Gantry Exit ANPR cameras automatically detect departing tankers, finalize loading,
            release the bay, and log ESG telemetry — closed-loop without manual dispatcher bottlenecks.
          </p>
        </div>
      </div>
    </div>
